...
import numpy as np
from base.discretization import FastFunction, finite_element
from base.mesh import Mesh
from base.system import LocallyAssembledVector, QuadratureBasedVectorEntryCalculator


class BasisL2ProductEntryCalculator(QuadratureBasedVectorEntryCalculator):
    ...
    def __init__(
        ...
        QuadratureBasedVectorEntryCalculator.__init__(
