...
class GlobalIndexMapping(index_mapping.IndexMapping):
    ...
    def __init__(self, mesh: Mesh, polynomial_degree: int, periodic=False):
...
class DOFNeighbourIndicesMapping(index_mapping.NeighbourIndicesMapping):
