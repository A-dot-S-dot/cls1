...
import numpy as np
from base.discretization import FastFunction
from base.mesh import AffineTransformation, Mesh
from base.quadrature import LocalElementQuadrature
from problem.scalar import BasisGradientL2Product, BasisL2Product
