...
import numpy as np
from fem.fast_element import FastFunction
from quadrature.local import LocalElementQuadrature
from system.vector.discrete_l2_product import BasisGradientL2Product, BasisL2Product
...
class TestLinearBasisL2Product(TestCase):
    ...
    def test_product(self):
        for fast_function, functions_string, expected_l2_product in zip(
            ...
            l2_product = self.l2_product_class(
