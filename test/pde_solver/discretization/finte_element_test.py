...
import numpy as np
from pde_solver.discretization import finite_element
...
class TestLinearLagrangeFiniteElementSpace(TestCase):
    ...
    element_space = finite_element.LagrangeFiniteElementSpace(mesh, polynomial_degree)
...
class TestLinearQuadratureFastFiniteElement(TestCase):
    ...
    element_space = finite_element.LagrangeFiniteElementSpace(mesh, 1)
...
class TestQuadraticQuadratureFastFiniteElement(TestLinearQuadratureFastFiniteElement):
    ...
    element_space = finite_element.LagrangeFiniteElementSpace(mesh, 2)
